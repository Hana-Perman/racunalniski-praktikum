...
ki jo v enačbah \eqref{eq:fp1} in \eqref{eq:fp2} izračunamo za sode in lihe vrednosti $r$.
...
Prevojne točke za različne vrednosti $k$ v teh dveh scenarijih so prikazane na slikah 1(\subref{fig:a515}) in 1(\subref{fig:a616}).
