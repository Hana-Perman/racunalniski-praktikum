...
- Odpri mapo: Ctrl+C+O
- Bližnjica do nabora ukazov: Ctrl + Shift + P  
- Prehajanje med programi, ki se izvajajo: Alt gr + tab 
...
<!--Oblikujte blok z izvorno kodo (v datoteki sta komentarja za začetek in konec bloka) - Kja to sploh pomeni?????.-->
