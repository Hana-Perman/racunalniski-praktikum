...
\theoremstyle{proof}
\newtheorem{izrekdokaz}{Dokaz}

\newenvironment{dokazovanje}{% 
...
{\begin{table}
\caption{Magični kvadrat reda #1} %   
\centering
\label{table:mag#1}
...
\begin{dokazovanje}
   ...
   enaka številu $\m(n)$. \eqref{eq:numbers}% sklica: eq:numbers, eq:numbers
\end{dokazovanje}
...
$A$, $A+D$, $A+2D$, \dots, $A+(n^2-1)D$, enaka \eqref{eq:mc}% sklic: eq:mc
...
Števila različnih normalnih magičnih kvadratov se nahajajo v tabeli \ref{tabela: zadnja}.
% sklic: table:stevila
